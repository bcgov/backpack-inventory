import * as server from '../entries/pages/(app)/scan/_officeId_/_productId_/_page.server.ts.js';

export const index = 15;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/scan/_officeId_/_productId_/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(app)/scan/[officeId]/[productId]/+page.server.ts";
