import * as server from '../entries/pages/(app)/transactions/add/_page.server.ts.js';

export const index = 16;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(app)/transactions/add/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(app)/transactions/add/+page.server.ts";
